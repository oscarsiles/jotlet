...
urlpatterns = [
    ...
    path("<slug:slug>/fetch/", views.BoardFetchView.as_view(), name="board-fetch"),
    ...
    path("<slug:slug>/posts/<int:pk>/reaction/<str:type>/", views.PostReactionView.as_view(), name="post-reaction"),
]

...
urlpatterns = [
    ...
    path("image_select/<str:type>/", views.board.ImageSelectView.as_view(), name="image-select"),
    ...
    path("<slug:slug>/topics/<int:topic_pk>/posts/create/", views.post.CreatePostView.as_view(), name="post-create"),
    path(

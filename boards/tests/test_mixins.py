...
class TestBoardListLinkHeaderMixin:
    def test_dispatch_anonymous(self, client):
        ...
        assert static("css/vendor/tagify-4.16.4.min.css") not in link_header
        assert static("js/vendor/tagify-4.16.4.min.js") not in link_header
    ...
    def test_dispatch_authenticated(self, client, user):
        ...
        assert f"<{static('js/vendor/tagify-4.16.4.min.js')}>; rel=preload; as=script" in link_header
        assert f"<{static('js/vendor/tagify-4.16.4.polyfills.min.js')}>; rel=preload; as=script" in link_header
